<div align="center">
  <p style="margin:0; font-size:32px;"><b>~ ❤️ 𝓦𝓮𝓵𝓬𝓸𝓶𝓮 𝓽𝓸 𝓶𝔂 𝓟𝓻𝓸𝓯𝓲𝓵𝓮 ❤️ ~</b></p>
  <a href="https://github.com/AvalonKoji">
    <img src="https://github.com/user-attachments/assets/720a00cd-1419-4d89-968a-276499b14b0c" style="width:85%; height:180px; object-fit:cover; border-radius:12px; margin-top:10px;" />
  </a>
  <div style="padding-top:35px; padding-bottom:25px;">
    <p style="margin:0; font-size:20px;"><i>“ 𝓑𝓮𝓲𝓷𝓰 𝓪𝓵𝓸𝓷𝓮 𝓲𝓼 𝓷𝓸𝓽 𝓼𝔂𝓷𝓸𝓷𝔂𝓶𝓸𝓾𝓼 𝔀𝓲𝓽𝓱 𝓫𝓮𝓲𝓷𝓰 𝓵𝓸𝓷𝓮𝓵𝔂. ”</i></p>
    <p style="margin:0; color:#666; font-size:16px;">— 𝓢𝓾𝔃𝓾𝓷𝓮 𝓗𝓸𝓻𝓲𝓴𝓲𝓽𝓪</p>
  </div>
</div>
